        ...
        <footer class="bottom-0 bg-white border-t-2 border-gray-100">
            <div class="container mx-auto px-4 py-4 max-w-screen-lg">
                <div class=" md:flex items-center text-gray-500 w-full mx-auto">
                    ...
                    <div class="flex-1 md:text-right space-x-3">
                        <a to="/" class="inline-block hover:text-indigo-600">
                            <svg class="h-4 w-4 sm:h-4 sm:w-4" viewBox="0 0 24 24" fill="none"
                        ...
                        <a to="/" class="inline-block hover:text-indigo-600">
                            <svg class="h-4 w-4 sm:h-4 sm:w-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512">
                                <path
